...
class CalcListFragment : Fragment() {
    ...
    val calcs = listOf(Calculator("Molar Mass", R.drawable.mass), Calculator("Stoichiometry", R.drawable.flasktime), Calculator("Wavelength", R.drawable.wave), Calculator("my ass", R.drawable.george))
